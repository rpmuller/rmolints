//! Optimized Head-Gordon-Pople implementation
//!
//! This version uses pre-allocated arrays and iterative HRR instead of
...
mod tests {
    ...
    fn test_hgp_opt_s_orbitals_same() {
        ...
        let result = electron_repulsion_hgp_opt(&s, &s, &s, &s);
    ...
    fn test_hgp_opt_separated_orbitals() {
        ...
        let result = electron_repulsion_hgp_opt(&s1, &s1, &s2, &s2);
    ...
    fn test_hgp_opt_px_orbitals() {
        ...
        let result = electron_repulsion_hgp_opt(&s, &s, &px, &px);

"""
Two electron integrals - Reference implementation from PyQuante2
Source: https://github.com/rpmuller/pyquante2/blob/master/src/pyquante2/ints/two.py
"""
...
def coulomb_repulsion(xyza, norma, lmna, alphaa,
    ...
    """
    Return the coulomb repulsion between four primitive gaussians a,b,c,d
    with the given origin, x,y,z, normalization constants norm, angular
    momenta l,m,n, and exponent alpha.
